...
class WeatherViewController: UIViewController {
    ...
    var temperList: [Temper] = [
        Temper(temper: "21", image: "cloud.rain.fill", weather: "Rainy", wind: "9km/h", humidity: "31%", chanceOfRain: "93%", weekend: "Monday, 17 May", isSelect: true),
        Temper(temper: "30", image: "sun.max.fill", weather: "Hot", wind: "3km/h", humidity: "23%", chanceOfRain: "93%", weekend: "TuesDay, 18 May", isSelect: false),
        Temper(temper: "22", image: "cloud.rain.fill", weather: "Cold", wind: "12km/h", humidity: "12%", chanceOfRain: "93%", weekend: "WednesDay, 19 May", isSelect: false),
        Temper(temper: "35", image: "sun.max.fill", weather: "Hot", wind: "2km/h", humidity: "23%", chanceOfRain: "93%", weekend: "ThursDay, 20 May", isSelect: false),
        Temper(temper: "21", image: "moon.fill", weather: "Slow", wind: "1km/h", humidity: "24%", chanceOfRain: "93%", weekend: "Friday, 21 May", isSelect: false),
        Temper(temper: "22", image: "cloud.fill", weather: "Slow", wind: "6km/h", humidity: "17%", chanceOfRain: "93%", weekend: "SaturDay, 22 May", isSelect: false),
        Temper(temper: "15", image: "cloud.drizzle.fill", weather: "Cold", wind: "11km/h", humidity: "34%", chanceOfRain: "93%", weekend: "Sunday, 23 May", isSelect: false)
    ]
    ...
    override func viewDidLoad() {
        ...
        self.blueBackgroundView.addSubview(minskStack)
...
extension WeatherViewController: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if temperList[indexPath.row].isSelect {
            cell.blueBackgroundView.backgroundColor = .systemBlue
        } else {
            cell.blueBackgroundView.backgroundColor = .clear
            cell.blueBackgroundView.layer.borderWidth = 1
...
extension WeatherViewController: Update {
    func update(indexPath: IndexPath) {
        ...
        self.weekendLabel.text = temperList[indexPath.row].weekend
